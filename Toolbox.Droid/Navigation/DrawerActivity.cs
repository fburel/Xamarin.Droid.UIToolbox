...
using Android.Util;
using Android.Views;
using Toolbox.Droid.Navigation.DrawerToogle;
    ...
    public abstract class DrawerActivity : BaseActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (OnPrepareSideMenu(menu))
            {
                ...
                Theme.ResolveAttribute(Android.Resource.Attribute.ColorBackground, a, true);
                if (a.Type >= DataType.FirstColorInt && a.Type <= DataType.LastColorInt)
                    navigationView.SetBackgroundColor(new Android.Graphics.Color(a.Data));
