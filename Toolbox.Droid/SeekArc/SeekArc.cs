...
namespace Toolbox.Droid.SeekArc
{
    ...
    public class SeekArc : View
    {
        ...
        public Android.Graphics.Color ProgressColor { get; set; }
        ...
        private void Init(Context context, IAttributeSet attrs, int defStyle)
        {
            ...
            var progressColor = ProgressColor == 0
                ? Resources.GetColor(Android.Resource.Color.HoloBlueLight)
                : ProgressColor;
            ...
            if (attrs != null)
            {
                ...
                Clockwise = a.GetBoolean(Resource.Styleable.SeekArc_clockwise,
                    Clockwise);
        ...
        {
            if (ProgressColor != 0) _progressPaint.Color = ProgressColor;

            if (!Clockwise) canvas.Scale(-1, 1, _arcRect.CenterX(), _arcRect.CenterY());
        ...
        {
            if (StartTrackingTouch != null) StartTrackingTouch(this, new SeekArcTrackingTouchEventArgs(this));
        }

        private void OnStopTrackingTouch()
        {
            if (StopTrackingTouch != null) StopTrackingTouch(this, new SeekArcTrackingTouchEventArgs(this));
        }
        ...
        private void UpdateOnTouch(MotionEvent motionEvent)
        {
            ...
            var progress = GetProgressForAngle(_touchAngle);
        ...
        private bool ShouldIgnoreTouch(float xPos, float yPos)
        {
            ...
            var touchRadius = (float) Math.Sqrt(x * x + y * y);
            if (touchRadius < _touchIgnoreRadius) ignore = true;
            return ignore;
        }
        ...
        private int GetProgressForAngle(double angle)
        {
            ...
            touchProgress = touchProgress < 0
                ...
                : touchProgress;
            touchProgress = touchProgress > _max
                ? InvalidProgressValue
                : touchProgress;
        ...
        {
            var thumbAngle = (int) (_startAngle + _progressSweep + _arcRotation + 90);
        ...
        {
            if (progress == InvalidProgressValue) return;

            ProgressChanged?.Invoke(this, new SeekArcProgressChangedEventArgs(this, progress, fromUser));
