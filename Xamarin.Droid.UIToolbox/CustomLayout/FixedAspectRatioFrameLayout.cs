...
namespace Xamarin.Droid.UIToolbox.CustomLayout
{
    /// <summary>
    ...
    public class FixedAspectRatioFrameLayout : FrameLayout
    {
        ...
        protected FixedAspectRatioFrameLayout(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference,
            transfer)
        {
        }
        ...
        public FixedAspectRatioFrameLayout(Context context, IAttributeSet attrs, int defStyleAttr) : base(context,
            attrs, defStyleAttr)
        {
        }

        public FixedAspectRatioFrameLayout(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) :
