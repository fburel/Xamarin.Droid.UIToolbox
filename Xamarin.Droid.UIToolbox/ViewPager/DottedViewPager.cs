...
namespace Xamarin.Droid.UIToolbox.ViewPager
{
    ...
    public class DottedViewPager<T> : RelativeLayout
    {
        ...
        private AndroidX.ViewPager.Widget.ViewPager _pager;
        ...
        {
            // Create the pager
            _pager = new AndroidX.ViewPager.Widget.ViewPager(Context);
...
//            _tabLayout.SetupWithViewPager(_pager);
        ...
        private void OnPageChanged(object sender, AndroidX.ViewPager.Widget.ViewPager.PageSelectedEventArgs e)
        {
